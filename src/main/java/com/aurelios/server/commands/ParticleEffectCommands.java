...
import com.aurelios.server.util.particles.AnimationData;
import com.aurelios.server.util.particles.ParticleData;
import com.aurelios.server.util.particles.PreloadedParticle;
import com.aurelios.server.util.particles.effects.*;
import com.aurelios.server.util.particles.effects.options.EffectOptionAnimationData;
import com.aurelios.server.util.particles.effects.options.EffectOptionCasterRotation;
import com.aurelios.server.util.particles.effects.options.EffectOptionIterate;
