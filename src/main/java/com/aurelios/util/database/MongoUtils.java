package com.aurelios.util.database;

import com.aurelios.game.environment.nodes.Node;
import com.aurelios.game.environment.nodes.PointOfInterest;
import com.aurelios.game.environment.nodes.shapes.Shape;
import com.aurelios.game.environment.nodes.shapes.ShapeCircle;
import com.aurelios.game.environment.nodes.shapes.ShapeRectangle;
import com.aurelios.game.user.ai.AIMetaData;
import com.aurelios.game.user.ai.NPC;
import com.aurelios.game.user.ai.traits.*;
import com.aurelios.game.user.ai.traits.personality.Personalities;
import com.aurelios.game.user.ai.traits.personality.Personality;
import com.aurelios.managers.Managers;
import com.aurelios.util.misc.StringUtils;
import com.aurelios.util.misc.UUIDUtils;
...
public class MongoUtils {
    ...
    public void openConnection(){
        try {
            ...
            if (database == null) {
                database = client.getDatabase("com.aurelios-sponge");
            }
        } catch( Exception e){
